    ...
    <li className={`${activeClass} hoverable hover:text-secondary `}>
      ...
      >
        <button
          ...
          className={`block cursor-pointer py-6  ${isAr ? "pr-2 lg:pr-4 pl-0 lg:pl-0" : "pl-2 lg:pl-4 lg:pr-4"
            ...
            {links.map((linkGroup, index) => (
              <div className=" basis-3/12 flex justify-between">
                <ul key={index} className={`px-4 w-full  pb-6 pt-6 lg:pt-3`}>
                  <h3
                    className={`flex gap-2 items-center underline text-base 2xl:text-[19px] text-secondary mb-2 ${isAr ? "text-right" : "text-left"
                      }`}
                  >
  ...
  const navigationData = [
    {
      title: t("about.lable"),
      href: "/about-us",
      locale: "en,ru_RU", description: "At our core, our clients are our utmost priority. With global regulation in place, we proudly serve over 895,000 clients worldwide.",
      links: [
        {
          icon: <IoHomeOutline />,
